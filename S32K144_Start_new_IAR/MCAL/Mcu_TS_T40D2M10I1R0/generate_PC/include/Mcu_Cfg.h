...
*/
#define MCU_CMU_PMC_SCG_INTERRUPT  [!IF "ecu:get('MCU.CMU.UNITS') > '0'"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]
...
[!IF "(McuGeneralConfiguration/McuCmuNotification != '') and (McuGeneralConfiguration/McuCmuNotification != 'NULL_PTR') and (McuGeneralConfiguration/McuCmuNotification != 'NULL')"!]
/**
...
*/
#define MCU_CMU_ERROR_ISR_USED [!IF "McuModuleConfiguration/McuClockSrcFailureNotification = 'ENABLED'"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]
