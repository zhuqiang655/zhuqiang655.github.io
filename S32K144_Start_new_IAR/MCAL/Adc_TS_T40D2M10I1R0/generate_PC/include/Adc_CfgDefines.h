...
[!NOCODE!][!//
/** added for AdcOptimizeOneShotHwTriggerConversions feature */
[!VAR "maxUnit"="num:i(ecu:get('Adc.AdcConfigSet.AdcHwUnit'))-1"!][!//
[!FOR "Unit" = "0" TO "num:i($maxUnit)"!][!//
    [!VAR "foundDma"="0"!][!//
    [!VAR "mcl_HwId"="0"!][!//
[!LOOP "AdcConfigSet/AdcHwUnit/*"!][!//
      [!VAR "temp" = "num:i(substring-after(string(AdcHwUnitId),'ADC'))"!][!//
      [!LOOP "node:refs('ASPathDataOfSchema:/TS_T40D2M10I1R0/Mcl')/MclConfigSet/*[1]/DMAChannel/*"!][!//
      [!IF "$Unit = $temp"!][!//
        [!VAR "temp2"="node:value(string(concat('DmaSource',string(num:i(num:i(substring-after(DmaHwChannel,'eDMA_')) div 16)))))"!][!//
        [!IF "$temp2 = concat('ADC',$Unit,'_COCO')"!][!//
          [!VAR "foundDma"="1"!][!//
          [!VAR "mcl_HwId"="substring-after(string(DmaHwChannel), 'eDMA_')"!][!//
          [!BREAK!][!//
        [!ENDIF!][!//
      [!ENDIF!][!//
      [!ENDLOOP!][!//
[!ENDLOOP!][!//
[!CODE!][!//
#define ADC_UNIT_[!"$Unit"!]_ASSOCIATED_DMA_HW_CHANNEL   ([!"num:i($mcl_HwId)"!]U)
[!ENDCODE!][!//
[!ENDFOR!][!//
[!ENDNOCODE!][!//
#endif
...
#define ADC_DOUBLE_BUFFERING_MORE_THAN_ONE_CHANNEL       [!IF "NonAutosar/DoubleBufferingMoreThanOneChannel"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]
