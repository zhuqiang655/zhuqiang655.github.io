...
#define DEM_CFG_EQ2_AGINGCYCLEIDOFEVENTTABLE                          DemConf_DemOperationCycle_IgnitionCycle
...
#define Dem_Cfg_GetConfigurationIdOfPCConfig()                        0x80F2u  /**< Magic constant derived from the configuration parameters /Dem/DemGeneral/DemCompiledConfigId and /Dem/DemGeneral/DemCompiledPostbuildCrc. Each value change is evidence to incompatible NV stored data and triggers a re-initialization of the NV data. */
...
#define Dem_Cfg_GetAgingCycleIdOfEventTable(Index)                    DemConf_DemOperationCycle_IgnitionCycle  /**< DemOperationCycle (ID) referenced by DemEventParameter/DemEventClass/DemAgingCycleRef */
...
#endif  /* DEM_LCFG_H */
/**********************************************************************************************************************
  END OF FILE: Dem_Lcfg.h     [Vector, VARIANT-PRE-COMPILE, 13.03.00.101592]
**********************************************************************************************************************/
