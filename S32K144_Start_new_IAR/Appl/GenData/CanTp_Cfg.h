...
#endif
#ifndef CANTP_PROCESSOR_S32K148
#define CANTP_PROCESSOR_S32K148
#endif
...
#define CANTP_CFG_GEN_PATCH_VERSION                                            3u 
...
#define CANTP_GENERATOR_COMPATIBILITY_VERSION                                  0x00057AACuL                                                   /* Extended error detection capabilities */ 
...
/* -----------------------------------------------------------------------------
    &&&~ Rx Sdu Handle IDs
----------------------------------------------------------------------------- */
#define CanTpConf_CanTpRxNSdu_CanTpRxNSdu_85e31bc0 0u 
#define CanTpConf_CanTpRxNSdu_CanTpRxNSdu_678e3b4e 1u 

 
/* -----------------------------------------------------------------------------
    &&&~ Tx Sdu Handle IDs
----------------------------------------------------------------------------- */
#define CanTpConf_CanTpTxNSdu_CanTpTxNSdu_85e31bc0 0u 


/* -----------------------------------------------------------------------------
    &&&~ Rx Pdu IDs
 ----------------------------------------------------------------------------- */
#define CanTpConf_CanTpRxFcNPdu_CanTpRxFcNPdu_5d18832b 0u 
#define CanTpConf_CanTpRxNPdu_CanTpRxNPdu_7fe257d9     0u 
#define CanTpConf_CanTpRxNPdu_CanTpRxNPdu_55155daa     1u 


/* -----------------------------------------------------------------------------
    &&&~ TxConfirmation Pdu IDs
 ----------------------------------------------------------------------------- */
#define CanTpConf_CanTpTxFcNPdu_CanTpTxFcNPdu_7fe257d9 0u 
#define CanTpConf_CanTpTxNPdu_CanTpTxNPdu_5d18832b     0u 
...
#define CANTP_EQ2_CANIFTXPDUIDOFTXSDUCFG                              CanIfConf_CanIfTxPduCfg_msg_diag_Response_MyECU_Tp_oCAN00_59e48f7a_Tx
...
#define CANTP_EQ2_RXFCPDUIDOFTXSDUCFG                                 CanTpConf_CanTpRxFcNPdu_CanTpRxFcNPdu_5d18832b
...
#define CANTP_EQ2_TXPDUCONFIRMATIONPDUIDOFTXSDUCFG                    CanTpConf_CanTpTxNPdu_CanTpTxNPdu_5d18832b
...
#define CANTP_INIT_DATA_HASH_CODE                                     835452236L  /**< the precompile constant to validate the initialization structure at initialization time of CanTp with a hashcode. The seed value is '0x231Eu' */
...
#define CanTp_GetCompatibilityVersionOfPCConfig()                     359084uL
...
#define CanTp_GetCanIfTxPduIdOfTxSduCfg(Index)                        CanIfConf_CanIfTxPduCfg_msg_diag_Response_MyECU_Tp_oCAN00_59e48f7a_Tx
...
#define CanTp_GetRxFcPduIdOfTxSduCfg(Index)                           CanTpConf_CanTpRxFcNPdu_CanTpRxFcNPdu_5d18832b
...
#define CanTp_GetTxPduConfirmationPduIdOfTxSduCfg(Index)              CanTpConf_CanTpTxNPdu_CanTpTxNPdu_5d18832b
