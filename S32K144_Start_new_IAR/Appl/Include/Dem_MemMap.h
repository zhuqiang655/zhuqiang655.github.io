...
# define OS_STOP_SEC_OsApplication_NonTrusted_Core0_VAR_ZERO_INIT_UNSPECIFIED
  ...
  #if defined (DEM_START_SEC_SystemApplication_OsCore0_VAR_ZERO_INIT_UNSPECIFIED)
  # undef DEM_START_SEC_SystemApplication_OsCore0_VAR_ZERO_INIT_UNSPECIFIED
  # define OS_START_SEC_SystemApplication_OsCore0_VAR_ZERO_INIT_UNSPECIFIED
  #endif

  #if defined (DEM_STOP_SEC_SystemApplication_OsCore0_VAR_ZERO_INIT_UNSPECIFIED)
  # undef DEM_STOP_SEC_SystemApplication_OsCore0_VAR_ZERO_INIT_UNSPECIFIED
  # define OS_STOP_SEC_SystemApplication_OsCore0_VAR_ZERO_INIT_UNSPECIFIED
  #endif
