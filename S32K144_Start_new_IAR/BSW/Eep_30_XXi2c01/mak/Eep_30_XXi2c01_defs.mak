###############################################################################
# File Name  : Eep_XXi2c01_defs.mak                                           #
...
# 2014-07-14   1.00     Ou   Adapt it for DrvEep_XXi2c01Asr                   #
# 2017-02-16   1.01.00  Gmi  Added new file due to new implementation         #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
EEP_30_XXI2C01_CORE_PATH       =  $(SSC_ROOT)\Eep_30_XXi2c01


# e.g.: CAN_OUTPUT_PATH = $(GENDATA_DIR)
EEP_30_XXI2C01_OUTPUT_PATH     =  $(GENDATA_DIR)
...
EEP_30_XXI2C01_DEPENDENT_PLUGINS =
...
#------------------------------------------------------------------------------------------
CC_INCLUDE_PATH     +=  $(EEP_XXI2C01_CORE_PATH)  $(EEP_XXI2C01_OUTPUT_PATH)
CPP_INCLUDE_PATH    +=
ASM_INCLUDE_PATH    +=
