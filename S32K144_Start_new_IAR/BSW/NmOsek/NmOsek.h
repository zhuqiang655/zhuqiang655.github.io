 ...
 *  8.00.00  2017-04-10   visgle  STORYC-2555   S0 Main Design Silent Analysis and implementation
 *                                STORYC-237    S1 Maintain test specification and Test Coverage Part I
 *                                STORYC-238    S2 Maintain test specification and Test Coverage Part II
 *                                STORYC-236    S3 Finalization
 *********************************************************************************************************************/
...
# define NMOSEK_SW_MAJOR_VERSION                 (8u)
...
# define NMOSEK_E_INVALID_GENDATA                (0x33U) /*!< Error code: The value of a variable used for write accesses is out of bounds */
 ...
 *********************************************************************************************************************/
/*! \brief        Notifies NmOsek when BusOff has been detected
 *  \details      Set BusOff detected flag on BusOff occurrence.
 *  \param[in]    NetworkHandle         Identification of the NM-channel
 *  \param[in]    OnlineDelayCyclesPtr  Ignored parameter
 *  \context      TASK|ISR1|ISR2
 *  \reentrant    TRUE
 *  \synchronous  TRUE
 *  \config       (NMOSEK_BUS_OFF_NOTIFICATION_ENABLED == STD_ON) && defined(NMOSEK_CDD_USED)
 *  \pre          -
 *  \note         Called by CddFiat
 *  \trace        CREQ-119861
 *********************************************************************************************************************/
extern FUNC(void, NMOSEK_CODE) NmOsek_CanSM_BusOffBegin(NetworkHandleType NetworkHandle,
                                                        P2VAR(uint8, AUTOMATIC, NMOSEK_APPL_VAR) OnlineDelayCyclesPtr);

/**********************************************************************************************************************
 *  NmOsek_CanSM_BusOffEnd()
 *********************************************************************************************************************/
/*! \brief        Notifies NmOsek when BusOff recovery attempt has been finished
 *  \details      Clear BusOff detected flag on BusOff recovery attempt.
 *  \param[in]    NetworkHandle         Identification of the NM-channel
 *  \context      TASK|ISR1|ISR2
 *  \reentrant    TRUE
 *  \synchronous  TRUE
 ...
 *  \trace        CREQ-119862
 *********************************************************************************************************************/
extern FUNC(void, NMOSEK_CODE) NmOsek_CanSM_BusOffEnd(NetworkHandleType NetworkHandle);
# endif
