...
# --------     ---------------------     -------------------------------------#
# ygr          Yves Grau                 Vector Informatik GmbH               #
#-----------------------------------------------------------------------------#
#               R E V I S I O N   H I S T O R Y                               #
#-----------------------------------------------------------------------------#
# Date         Version  Sign Description                                      #
# ----------   -------  ---- -------------------------------------------------#
# 2017/09/28   1.00     ygr  Initial Version                                  #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
LIBRARIES_TO_BUILD      += vDem42
vDem42_FILES             = vDem42\vDem42.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += vDem42\vDem42.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
#GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\vDem42_Cfg.c
