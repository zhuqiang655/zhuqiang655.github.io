...
/* Use Schedule Manager to disable/restore interrupts, Include made in WdgM_Types.h */
#else
# if (WDGM_USE_USER_SUSPEND_INTERRUPT == STD_ON) /* COV_WDGM_MISRA */
/* User defined functions for global interrupt disable/enable */
void GlobalSuspendInterrupts(void); /* PRQA S 3408 */ /* MD_WdgM_3408 */
void GlobalRestoreInterrupts(void); /* PRQA S 3408 */ /* MD_WdgM_3408 */
# else
