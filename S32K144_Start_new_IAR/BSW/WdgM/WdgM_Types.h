...
# define WDGM_TYPES_MAJOR_VERSION       (5u)
# define WDGM_TYPES_MINOR_VERSION       (3u)
# define WDGM_TYPES_PATCH_VERSION       (0u)

/* ----- Component version information (decimal version of generator package(CFG5)) ----- */
# define WDGM_GENERATOR_MAJOR_VERSION       (2u)
# define WDGM_GENERATOR_MINOR_VERSION       (2u)
...
typedef struct {
  ...
  void (*WdgM_LocalStatusChangeNotification) (WdgM_LocalStatusType); /*!< Intern notification function for local status
                                                                      *   change - NULL_PTR if not used
                                                                      */
...
typedef struct {
  ...
  void (*WdgM_GlobalStatusChangeNotification) (WdgM_GlobalStatusType); /*!< Intern notification function for global
                                                                        *   status change - NULL_PTR when not used
                                                                        */
