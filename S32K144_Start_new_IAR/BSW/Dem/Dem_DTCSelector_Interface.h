 ...
 *****************************************************************************/
/*!
 * \brief         Set the data of a DTC selection.
 *
 * \details       Set the data of a DTC selection.
 *
 * \param[in]     DTCSelectorId
 *                The selector to modify.
 * \param[in]     SelectionData
 *                The selection data to be set.
 *
 * \pre           -
 *
 * \context       TASK|ISR2
 ...
 *****************************************************************************/
/*!
 * \brief         Get the data of a DTC selection.
 *
 * \details       Get the data of a DTC selection.
 *
 * \param[in]     DTCSelectorId
 *                The selector to read.

 * \return        The data of the DTC selection
 *
 * \pre           -
 *
 * \context       TASK|ISR2
