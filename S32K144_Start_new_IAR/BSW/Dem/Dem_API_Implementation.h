...
# endif
  {
    ...
    case DEM_DTC_ORIGIN_PRIMARY_MEMORY:
      *OverflowIndication = Dem_MemState_GetOverflow(DEM_CFG_MEMORYID_PRIMARY);                                                       /* SBSW_DEM_POINTER_WRITE_API */
      lReturnValue = E_OK;
      break;

# if (DEM_CFG_SUPPORT_SECONDARY == STD_ON)
    case DEM_DTC_ORIGIN_SECONDARY_MEMORY:
      *OverflowIndication = Dem_MemState_GetOverflow(DEM_CFG_MEMORYID_SECONDARY);                                                     /* SBSW_DEM_POINTER_WRITE_API */
      lReturnValue = E_OK;
      break;
# endif
...
# if (DEM_CFG_SUPPORT_OBDII == STD_ON)
    case DEM_DTC_ORIGIN_PERMANENT_MEMORY:
      *OverflowIndication = Dem_MemState_GetOverflow(DEM_CFG_MEMORYID_PERMANENT);                                                     /* SBSW_DEM_POINTER_WRITE_API */
      lReturnValue = E_OK;
      break;
# endif
...
# endif
  {
    ...
    {
    case DEM_DTC_ORIGIN_PRIMARY_MEMORY:
      *NumberOfEventMemoryEntries = Dem_MemState_GetNumAllocatedMemoryEntry(DEM_CFG_MEMORYID_PRIMARY);                           /* SBSW_DEM_POINTER_WRITE_API */
      lReturnValue = E_OK;
      break;

# if (DEM_CFG_SUPPORT_SECONDARY == STD_ON)
    case DEM_DTC_ORIGIN_SECONDARY_MEMORY:
      *NumberOfEventMemoryEntries = Dem_MemState_GetNumAllocatedMemoryEntry(DEM_CFG_MEMORYID_SECONDARY);                         /* SBSW_DEM_POINTER_WRITE_API */
      lReturnValue = E_OK;
      break;
# endif
...
# if (DEM_CFG_SUPPORT_OBDII == STD_ON)
    case DEM_DTC_ORIGIN_PERMANENT_MEMORY:
      *NumberOfEventMemoryEntries = Dem_MemState_GetNumAllocatedMemoryEntry(DEM_CFG_MEMORYID_PERMANENT);                         /* SBSW_DEM_POINTER_WRITE_API */
      lReturnValue = E_OK;
      break;
# endif
...
# endif
  {
    ...
    DTRIdType lDtrId;
    /* Initialize all Dtrs */
    for (lDtrId = 0; lDtrId < Dem_DtrIF_GetGlobalDtrCount(); lDtrId++)
    {
