 ...
 *
 * \details       Set the readout buffer entry for the given handle
 *
 * \param[in,out] ReadoutBufferId
 *                Index of the ReadoutBuffer
 * \param[in]     ReadoutBufferEntry
 *                The readout buffer entry to be set
 *
 * \pre           -
 * \config        DEM_CFG_SUPPORT_DCM == STD_ON
 *
...
/* ****************************************************************************
 * Dem_DTCReadoutBuffer_GetReadoutBufferEntry()
 *****************************************************************************/
/*!
 * \brief         Returns the readout buffer entry
 *
 * \details       Returns the readout buffer entry for the given handle
 *
 * \param[in]     ReadoutBufferId
 *                Index of the ReadoutBuffer
 *
 * \return        The readout buffer entry
 *
 * \pre           -
 *
 * \context       TASK|ISR2
 ...
 *
 * \param[in]     OldExtendedDataIterator
 *                The extended data iterator to be initialized
 *
 * \return        The initialized extended data iterator
 *
 * \pre           -
 * \config        DEM_CFG_SUPPORT_DCM == STD_ON
 *
 ...
 * \details       Clear all members.
 *
 * \param[in]     OldSnapshotDataIterator
 *                The snapshot data iterator to be initialized
 *
 * \return        The initialized snapshot data iterator
 *
 * \pre           -
 * \config        DEM_CFG_SUPPORT_DCM == STD_ON
 *
