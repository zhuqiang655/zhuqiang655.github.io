...
# if (DEM_CFG_DATA_OCCCTR_2BYTE == STD_ON)
    lOccurrenceCounter = Dem_MemoryEntry_GetOccurrenceCounter2Byte(Dem_MemState_GetMemoryEntryId(BlockIndex));
# else
    lOccurrenceCounter = Dem_MemoryEntry_GetOccurrenceCounter(Dem_MemState_GetMemoryEntryId(BlockIndex));
# endif
