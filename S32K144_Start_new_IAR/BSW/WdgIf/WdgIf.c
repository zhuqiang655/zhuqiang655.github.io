...
#define WDGIF_SW_PATCH_VERSION_SOURCE             (2u)
  ...
  )
{
     ...
     )
  {
    ...
    (void)Det_ReportError (WDGIF_MODULE_ID, WDGIF_INSTANCE_ID, WDGIF_SID_SET_MODE, WDGIF_E_PARAM_DEVICE);
#endif /* WDGIF_DEV_ERROR_DETECT == STD_ON */
...
#if (WDGIF_DEV_ERROR_DETECT == STD_ON)
    /* #12 Raise the development error with error code WDGIF_E_PARAM_DEVICE */
    (void)Det_ReportError (WDGIF_MODULE_ID, WDGIF_INSTANCE_ID, WDGIF_SID_SET_TRIGGER_CONDITION, WDGIF_E_PARAM_DEVICE);
#endif /* WDGIF_DEV_ERROR_DETECT == STD_ON */
    /* #13 Abort and return E_NOT_OK */
    ret = E_NOT_OK;
  }
...
#if (WDGIF_DEV_ERROR_DETECT == STD_ON)
    /* #12 Raise the development error with error code WDGIF_E_PARAM_DEVICE */
    (void)Det_ReportError (WDGIF_MODULE_ID, WDGIF_INSTANCE_ID, WDGIF_SID_SET_TRIGGER_WINDOW, WDGIF_E_PARAM_DEVICE);
#endif /* WDGIF_DEV_ERROR_DETECT == STD_ON */
    /* #13 Abort and return E_NOT_OK */
    ret = E_NOT_OK;
  }
...
FUNC(void, WDGIF_CODE) WdgIf_GetVersionInfo(P2VAR(Std_VersionInfoType, AUTOMATIC, WDGIF_APPL_DATA) versioninfo)
{
  ...
  if (versioninfo == NULL_PTR)
  {
    ...
    (void)Det_ReportError (WDGIF_MODULE_ID, WDGIF_INSTANCE_ID, WDGIF_SID_GET_VERSION_INFO, WDGIF_E_INV_POINTER);
#endif /* WDGIF_DEV_ERROR_DETECT == STD_ON */
  }
