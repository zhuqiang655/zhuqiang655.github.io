...
# 2008/03/25   1.02     Fn   Adapted to AUTOSAR 3.0                           #
# 2008/04/30   1.03     fbg  Changes for ASR library support                  #
# 2009/04/17   1.04     Tvi  Changed Paths / Renamed files                    #
# 2009/11/11   1.05     Tvi  Renamed files                                    #
# 2010/05/02   1.06     Tvi  Renamed files                                    #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.6                                                       #
# MAKEFILE        = 0.2                                                       #
###############################################################################
...
CanTrcv_30_Tja1043_FILES    = CanTrcv_30_Tja1043\CanTrcv_30_Tja1043.c

# e.g.: CC_FILES_TO_BUILD += drv\CanTrcv_30_Tja1043dio.c
CC_FILES_TO_BUILD       += CanTrcv_30_Tja1043\CanTrcv_30_Tja1043.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
