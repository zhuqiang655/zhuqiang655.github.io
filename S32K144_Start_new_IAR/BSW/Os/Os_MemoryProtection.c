...
)
{
  ...
  Os_CoreSetCurrentStack(Os_CoreGetKernelStack(Os_Core2AsrCore(Os_CoreGetCurrentCore())));                              /* SBSW_OS_MP_CORE2ASRCORE_001 */ /* SBSW_OS_MP_COREGETKERNELSTACK_001 */ /* SBSW_OS_MP_CORESETCURRENTSTACK_001 */
