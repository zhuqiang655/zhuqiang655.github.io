 ...
 *  \details  --no details--
 */
#if !defined (OS_LOCAL)                                                                                                 /* COV_OS_COMPILERKEYWORD */
 ...
 *  \details  --no details--
 */
#if !defined (OS_LOCAL_INLINE)                                                                                          /* COV_OS_COMPILERKEYWORD */
