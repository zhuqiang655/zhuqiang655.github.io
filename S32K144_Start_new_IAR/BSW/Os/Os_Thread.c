...
\ID SBSW_OS_TRD_CORESETCURRENTSTACK_001
 \DESCRIPTION    Os_CoreSetCurrentStack is called with a Stack which is derived from a thread passed to the calling
                 function. Precondition ensures that the passed pointer is valid.
                 The compliance of the precondition is check during review.
