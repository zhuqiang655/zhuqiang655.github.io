...
)
{
  ...
  else
  {
    ...
    if(OS_UNLIKELY(Os_CoreAsrCheckIsCoreLocal(ownerCore) == OS_CHECK_FAILED))                                           /* COV_OS_HALPLATFORMTESTEDASMULTICORE */ /* SBSW_OS_SF_COREASRCHECKISCORELOCAL_001 */
    {
...
)
{
  ...
  else
  {
    ...
    if(OS_UNLIKELY(Os_CoreAsrCheckIsCoreLocal(ownerCore) == OS_CHECK_FAILED))                                           /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */ /* SBSW_OS_SF_COREASRCHECKISCORELOCAL_001 */
    {
      status = OS_STATUS_ACCESSRIGHTS_1;
    }
    else
