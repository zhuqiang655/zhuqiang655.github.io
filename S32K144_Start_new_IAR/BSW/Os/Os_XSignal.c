 ...
 */
#  pragma warning 549                                                                                                   /* PRQA S 3116 */ /* MD_MSR_1.1 */
# endif
/***********************************************************************************************************************
 *  Os_XSigInit()
 **********************************************************************************************************************/
...
)
{
  ...
  else
  {
    ...
    if(OS_UNLIKELY(Os_CoreAsrCheckIsCoreLocal(taskCore) == OS_CHECK_FAILED))                                            /* COV_OS_XSIGDOUBLECHECK */ /* SBSW_OS_XSIG_COREASRCHECKISCORELOCAL_001 */
    {
      status = OS_STATUS_CORE_CROSS_DATA;
    }
...
)
{
  ...
  else
  {
    ...
    if(OS_UNLIKELY(Os_CoreAsrCheckIsCoreLocal(counterCore) == OS_CHECK_FAILED))                                         /* COV_OS_XSIGDOUBLECHECK */ /* SBSW_OS_XSIG_COREASRCHECKISCORELOCAL_002 */
    {
      status = OS_STATUS_CORE_CROSS_DATA;
    }
    else if( OS_UNLIKELY(Os_AppCheckAccess(SendApp, permittedApplications) == OS_CHECK_FAILED) )                        /* COV_OS_XSIGDOUBLECHECK */ /* SBSW_OS_FC_PRECONDITION */
...
)
{
  ...
  else
  {
    ...
    if(OS_UNLIKELY(Os_CoreAsrCheckIsCoreLocal(alarmCore) == OS_CHECK_FAILED))                                           /* COV_OS_XSIGDOUBLECHECK */ /* SBSW_OS_XSIG_COREASRCHECKISCORELOCAL_003 */
    {
      status = OS_STATUS_CORE_CROSS_DATA;
    }
    else if( OS_UNLIKELY(Os_AppCheckAccess(SendApp, permittedApplications) == OS_CHECK_FAILED) )                        /* COV_OS_XSIGDOUBLECHECK */ /* SBSW_OS_FC_PRECONDITION */
...
)
{
  ...
  else
  {
    ...
    if(OS_UNLIKELY(Os_CoreAsrCheckIsCoreLocal(schTCore) == OS_CHECK_FAILED))                                            /* COV_OS_XSIGDOUBLECHECK */ /* SBSW_OS_XSIG_COREASRCHECKISCORELOCAL_004 */
    {
      status = OS_STATUS_CORE_CROSS_DATA;
    }
    else if( OS_UNLIKELY(Os_AppCheckAccess(SendApp, permittedApplications) == OS_CHECK_FAILED) )                        /* COV_OS_XSIGDOUBLECHECK */ /* SBSW_OS_FC_PRECONDITION */
...
)
{
  ...
  else
  {
    ...
    if(OS_UNLIKELY(Os_CoreAsrCheckIsCoreLocal(schTFromCore) == OS_CHECK_FAILED))                                        /* COV_OS_XSIGDOUBLECHECK */ /* SBSW_OS_XSIG_COREASRCHECKISCORELOCAL_004 */
    {
      status = OS_STATUS_CORE_CROSS_DATA;
    }
    else if(OS_UNLIKELY(Os_CoreAsrCheckIsCoreLocal(schTToCore) == OS_CHECK_FAILED))                                     /* COV_OS_XSIGDOUBLECHECK */ /* SBSW_OS_XSIG_COREASRCHECKISCORELOCAL_004 */
    {
      status = OS_STATUS_CORE_CROSS_DATA;
    }
...
)
{
  ...
  else
  {
    ...
    if(OS_UNLIKELY(Os_CoreAsrCheckIsCoreLocal(isrCore) == OS_CHECK_FAILED))                                             /* COV_OS_XSIGDOUBLECHECK */ /* SBSW_OS_XSIG_COREASRCHECKISCORELOCAL_005 */
    {
      status = OS_STATUS_CORE_CROSS_DATA;
    }
    else
...
)
{
  ...
  else
  {
    ...
    else
    {
      ...
      if(OS_UNLIKELY(Os_CoreAsrCheckIsCoreLocal(coreRef) == OS_CHECK_FAILED))                                           /* COV_OS_XSIGDOUBLECHECK */ /* SBSW_OS_XSIG_COREASRCHECKISCORELOCAL_006 */
      {
        status = OS_STATUS_CORE_CROSS_DATA;
      }
      else
...
)
{
  ...
  else
  {
    ...
    if(OS_UNLIKELY(Os_CoreAsrCheckIsCoreLocal(appCore) == OS_CHECK_FAILED))                                             /* COV_OS_XSIGDOUBLECHECK */ /* SBSW_OS_XSIG_COREASRCHECKISCORELOCAL_007 */
    {
      status = OS_STATUS_CORE_CROSS_DATA;
    }
    else
...
)
{
  ...
  else
  {
    ...
    if(OS_UNLIKELY(Os_CoreAsrCheckIsCoreLocal(callbackCore) == OS_CHECK_FAILED))                                /* COV_OS_XSIGDOUBLECHECK */ /* SBSW_OS_XSIG_COREASRCHECKISCORELOCAL_005 */
    {
      status = OS_STATUS_CORE_CROSS_DATA;
    }
