...
)
{
  ...
  else
  {
    ...
    else
    {
      ...
      if(OS_LIKELY(Os_AppIsCoreLocal(scheduleTable->OwnerApplication) != 0))                                            /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */ /* SBSW_OS_SCHT_APPISCORELOCAL_001 */
      {
...
)
{
  ...
  else
  {
    ...
    {
      if(OS_LIKELY(Os_AppIsCoreLocal(scheduleTable_From->OwnerApplication) != 0))                                       /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */ /* SBSW_OS_SCHT_APPISCORELOCAL_001 */
      {
        Os_IntStateType interruptState;
...
)
{
  ...
  else
  {
    ...
    else if(OS_UNLIKELY(Os_CoreAsrCheckIsCoreLocal(Os_AppGetCore(scheduleTable->OwnerApplication)) == OS_CHECK_FAILED)) /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */ /* SBSW_OS_SCHT_COREASRCHECKISCORELOCAL_001 */ /* SBSW_OS_SCHT_APPGETCORE_001 */
    {
 ...
 */
#  pragma warning 541                                                                                                   /* PRQA S 3116 */ /* MD_MSR_1.1 */
# endif
/***********************************************************************************************************************
