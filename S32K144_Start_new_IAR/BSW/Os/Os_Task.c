...
)
{
  ...
  else
  {
    ...
    else
    {
      ...
      if(OS_LIKELY(Os_CoreAsrIsCoreLocal(targetCore) != 0))                                                             /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */ /* SBSW_OS_TASK_COREASRISCORELOCAL_001 */
      {
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if(OS_LIKELY(Os_TaskIsCoreLocal(targetTask) != 0))                                                              /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */ /* SBSW_OS_TASK_TASKISCORELOCAL_001 */
        {
...
)
{
  ...
  if(OS_LIKELY(Os_TaskIsCoreLocal(Task) != 0))                                                                          /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */ /* SBSW_OS_FC_PRECONDITION */
  {
