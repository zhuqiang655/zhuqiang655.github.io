...
#if !defined (OS_HAL_DERIVATIVE_GENERIC_CORTEXM_MPINT_H) /* PRQA S 0883 */ /* MD_Os_Hal_0883 */
# define OS_HAL_DERIVATIVE_GENERIC_CORTEXM_MPINT_H
...
#endif /* OS_HAL_DERIVATIVE_GENERIC_CORTEXM_MPINT_H */

/*!
 * \}
 */
/**********************************************************************************************************************
 *  END OF FILE: Os_Hal_Derivative_Generic_CortexM_MpInt.h
 *********************************************************************************************************************/
