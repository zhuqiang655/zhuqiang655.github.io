...
))
{
  ...
  if(OS_LIKELY(Os_CoreAsrIsCoreLocal(Counter->Core) != 0))                                                              /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */ /* SBSW_OS_FC_PRECONDITION */
  {
...
)
{
  ...
  else
  {
    ...
    else if(OS_UNLIKELY(Os_CoreAsrCheckIsCoreLocal(me->Core) == OS_CHECK_FAILED))                                       /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */ /* SBSW_OS_CNT_COREASRISCORELOCAL_001 */
    {
