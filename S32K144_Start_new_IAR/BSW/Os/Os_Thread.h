...
))
{
  ...
  if(Os_ThreadIsFpuContextEnabled() != 0)
  {
...
))
{
  ...
  Os_CoreSetCurrentStack(Next->Stack);                                                                                  /* SBSW_OS_TRD_CORESETCURRENTSTACK_001 */
...
))
{
  ...
  *CalleeContext = &calleeContext;                                                                                      /* SBSW_OS_PWA_PRECONDITION */ /* PRQA S 3225 */ /* MD_Os_3225 */
  ...
  if(Os_ThreadIsFpuContextEnabledForThread(Thread) != 0)                                                                /* SBSW_OS_FC_PRECONDITION */
  {
    /*!
     * Internal comment removed.
 *
 ...
 *
  ...
  *CalleeContext = NULL_PTR;                                                                                            /* SBSW_OS_PWA_PRECONDITION */ /* PRQA S 3225 */ /* MD_Os_3225 */
...
))
{
  ...
  *CalleeContext = &calleeContext;                                                                                      /* SBSW_OS_PWA_PRECONDITION */ /* PRQA S 3225 */ /* MD_Os_3225 */
  ...
  /* #20 If the calling thread needs saving of the FPU context: */
  if(Os_ThreadIsFpuContextEnabledForThread(Thread) != 0)                                                                /* COV_OS_UNSUPPORTED89701_XF */ /* SBSW_OS_FC_PRECONDITION */
  {
    /*!
     * Internal comment removed.
 *
...
))
{
  ...
  if(Os_ThreadIsFpuContextEnabled() != 0)
  {
    ...
    if(Os_ThreadAllThreadsUseFpu() != 0)
    {
      result = !0;
    }
...
))
{
  ...
  return (OS_CFG_THREAD_FPU_CONTEXT_FOR_ALL_THREADS_ENABLED == STD_ON);
}
...
))
{
  ...
  return (OS_CFG_THREAD_FPU_CONTEXT_ENABLED == STD_ON);
}
