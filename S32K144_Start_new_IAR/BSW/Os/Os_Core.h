 ...
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_StdReturnType, OS_CODE, OS_ALWAYS_INLINE, Os_CoreIsSingleCoreOs,        /* PRQA S 3219 */ /* MD_Os_3219 */
(void))
{
  return (Os_StdReturnType)(OS_COREID_COUNT == 1);
}
 ...
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_StdReturnType, OS_CODE, OS_ALWAYS_INLINE, Os_CoreIsSingleAsrCoreOs,     /* PRQA S 3219 */ /* MD_Os_3219 */
(void))
{
  return (Os_StdReturnType)(OS_COREASRCOREIDX_COUNT == 1);
}
...
))
{
  ...
  return (Os_StdReturnType)((Os_CoreIsSingleAsrCoreOs()) || (Core == localCore));                                       /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
}
...
))
{
  ...
  if(Os_CoreIsSingleCoreOs() != 0)                                                                                      /* COV_OS_TESTSUITERESTRICTIONMULTICORE_XF */
  {
...
{
  Os_CoreAsrGetDyn(Os_Core2AsrCore(Os_CoreGetCurrentCore()))->CurrentStack = Stack;                                     /* SBSW_OS_CORE_CORE2ASRCORE_002 */ /* SBSW_OS_CORE_COREASRGETDYN_002 */ /* SBSW_OS_CORE_COREASR_DYN_001 */
}
